---
name: pm-docs
description: Generates product management documents — PRDs, one-pagers, decision logs, and launch checklists — from conversation context and codebase analysis.
version: 1.0.0
author: willjasen
tags:
  - pm
